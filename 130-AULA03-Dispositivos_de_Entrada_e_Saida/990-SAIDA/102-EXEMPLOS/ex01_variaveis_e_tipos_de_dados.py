...
# CLASSE: CONTATO
class Contato:
	def __init__(self, nomePessoa, telefonePessoa, emailPessoa):
		self.nome = nomePessoa;
		self.telefone = telefonePessoa;
		self.email = emailPessoa;
...
# VARIAVEL: CARACTER ASCII
def teste1001_codigoASCII():
	for i in range(64, 120):
		ch = chr(i);
		print( i, ch );

# VARIAVEL: NOME_EM ASCII
def teste1002_nomeEmASCII():
	nome = "Wendell Rodrigues Ferreira";
	sz = len(nome);
	for i in range(0, sz):
		ch = nome[i];
		print( ch );
...
# VARIAVEL: CONTATO
def teste1003_contato():
	c1 = Contato("Jose", "(21)2121-2121", "jose@test.com");
	c2 = Contato("Joao", "(21)2020-2020", "joao@test.com");
...
#teste1001_codigoASCII();
#teste1002_nomeEmASCII();
teste1003_contato();